...
?>
    ...
    <main id="primary" class="site-main">
        ...
        <section class="container">
            <div class="row">
                <div class='col-12 offset-0 offset-lg-0 col-lg text-center pb-4'>
                    <img src="<?php echo get_template_directory_uri(); ?>/img/wallpaper3.jpg" class="rounded-circle"
                         alt="...">
                    <h2>Example paragraph</h2>
                    <p>Example desc</p>
                    <div class='btn p-2 btn-secondary rounded-pill'>Book Online</div>
                </div>
                <div class='col-12  offset-0 offset-lg-0 col-lg text-center  pb-4'>
                    <img src="<?php echo get_template_directory_uri(); ?>/img/wallpaper3.jpg" class="rounded-circle"
                         alt="...">
                    <h2>Example paragraph</h2>
                    <p>Example desc</p>
                    <div class='btn btn-secondary rounded-pill'>Book Online</div>
                </div>
                <div class='col-12  offset-0 offset-lg-0 col-lg text-center  pb-4'>
                    <img src="<?php echo get_template_directory_uri(); ?>/img/wallpaper3.jpg" class="rounded-circle"
                         alt="...">
                    ...
                    <div style="background-image: linear-gradient(to left, rgba(255,0,0,0), rgba(233, 243, 225, 1)); height: 100%; width:100%;">
                        <div class="row">
                            <div class="col-12 col-lg-12 mt-5">
                                <h6 class="text-center">Common Questions About Acupuncture Treatment</h6>
                                <hr style="width:3%;" class="p-1">
                                ...
                                <div class="row ml-5">
                                    ...
                                    <div class="col-10 col-lg-10">
                                        <div class="row justify-content-center">
                                            <div class="col-12 col-lg-12 float-start">
                                                <h6>Does acupuncture have any side effects?</h6>
                                            </div>
                                            <div class="row">
                                                <div class="col-12 col-lg-12">
                                                    <p>Acupuncture therapy is widely accepted because of the fact that
                                                        it <br>has no serious side effects.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <section class="container mt-5 mb-5">
            <div class='col col-lg'>
                <h6 class="text-center">What We Provide</h2>
            </div>
            <hr style="width:3%;">
            <div class='col col-lg'>
                <h2 class="text-center">Our Treatment</h2>
            </div>

            <div class="row mt-5 mb-5">
                <div class="col-6 col-lg-2"><h1 class="text-center"><i class="bi bi-bookmark-star-fill"></i></h1></div>
                <div class="col-6 col-lg-2"><h1 class="text-center"><i class="bi bi-bookmark-star-fill"></i></h1></div>
                <div class="col-6 col-lg-2"><h1 class="text-center"><i class="bi bi-bookmark-star-fill"></i></h1></div>
                <div class="col-6 col-lg-2"><h1 class="text-center"><i class="bi bi-bookmark-star-fill"></i></h1></div>
                <div class="col-6 col-lg-2"><h1 class="text-center"><i class="bi bi-bookmark-star-fill"></i></h1></div>
        ...
        <section class="container mt-5 mb-5 p-5">
            ...
            <div class="row">
                ...
                <div class='col-12 col-lg-12 pt-4'>
                    ...
                    <h6 class="text-center">What we offer</h2>
                </div>
                <hr style="width:3%;">
                <div class='col-12 col-lg-12 mb-5 '>
                    <h2 class="text-center">Special pricing</h2>
                </div>
            </div>

            <div class="row justify-content-center">
                <div class="col-12 col-lg-2">
                    <button type="button" class="btn btn-outline-info">Acupressure</button>
                </div>
                <div class="col-12 col-lg-2">
                    <button type="button" class="btn btn-outline-info">Auriculotherapy</button>
                </div>
                <div class="col-12 col-lg-2">
                    <button type="button" class="btn btn-outline-info">Magnetotherapy</button>
                </div>
                <div class="col-12 col-lg-2">
                    <button type="button" class="btn btn-outline-info">Reflexology</button>
                </div>
            </div>
            ...
            <div class="row m-4">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="card mb-3" style="max-width: 540px; border:none; border-bottom:4px double gray;">
                        <div class="row g-0">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                <div class="card-body">
                                    <h5 class="card-title">Hair Transplant Treatment</h5>
                                    <p class="card-text">Maecenas nec odio et ante tincidunt</p>
                                </div>
                            </div>
                            <div class="col-2 col-md-2 justify-content-start mt-5"><strong><h3>$45</h3></strong></div>
                        </div>
    ...
    background-image: url('https://1scyiu2n1n5idktsl3ylwkq1-wpengine.netdna-ssl.com/wp-content/uploads/2018/07/Parallax-img.jpg');
    background-attachment: scroll; 
    min-width: 1519px; 
    left: 0px; 
    width: 1518px; 
    background-position: 50% 16px;" 
    class="back-image container mt-5 mb-5 p-5">
           
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-2 text-center">
                        <h2><i class="bi bi-arrow-up-square-fill"></i></h2>
                        <h1 class="text-white">250</h1>
                        <hr class="text-light" style="width: 25px; height:2px;">
                        <p class="text-white">Therapist</p>
                    </div>
                    <div class="col-12 col-lg-2 text-center">
                        <h2><i class="bi bi-arrow-up-square-fill"></i></h2>
                        <h1 class="text-white">250</h1>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-auto p-5">
                        <div class="bg-secondary p-4 text-center" style="opacity:0.5;">Are You Putting Up With Pain? You Shouldn’t.</div>
                    </div>
                </div>

                <div class="row mt-4">
                    <h4 class="col-12 col-lg-12 text-center text-white">Explane your Health Problem</h4>
                </div>
                <hr class="text-light" style="width: 25px; height:2px;">
                <div class="row mt-2">
                    <h3 class="col-12 col-lg-12 text-center text-white">Get an Appointment</h3>
                </div>
            ...
            <div class="mini-box">
            <div class="btn btn-secondary text-white p-2 text-center" style="width:80%; border-radius:20px;">Get An Appointment
            </div>
            </div>
            </div>
        ...
        <section class="container mt-5 mb-5">
            <div class='col col-lg'>
                <h6 class="text-center">Therapy That We Provide</h2>
            </div>
            <hr style="width:25px; height:3px;">
            <div class='col col-lg'>
                <h2 class="text-center">Therapy Pricing</h2>
            </div>
            ...
            <div class="row mt-5 text-center">
                ...
                <div class="col-12 col-lg-4 align-items-center justify-content-center">
                    <div class="card p-3" style="background-color:gray;">
                        ...
                        <div class="card-body">
                        <hr class="text-white" style="width:25px; height:3px;">
                            <h5 class="card-title text-white">Card title</h5>
                            
                            <p class="card-text text-white">Duration : 30 min</p>
                            <div
                            ...
                            <a href="#" style="background-color:#68605e; border-radius:20px;" class="btn text-white mb-3 mt-2">View procedure details</a>
                        </div>
                    </div>
                </div>
        ...
        <!-- Eighth section -->
        <section 
        class="back-image2 container-fluid mt-5 mb-5 p-5" 
        style=
    "background-size: cover;
    background-repeat: no-repeat;
    background-color: rgba(0, 0, 0, 0);
    background-image: url('https://1scyiu2n1n5idktsl3ylwkq1-wpengine.netdna-ssl.com/wp-content/uploads/2018/07/Parallax-img-2.jpg');
    background-attachment: scroll;
    min-width: 1519px;
    left: 0px;
    width: 1518px;
    background-position: 50% -22px;">
            <div class="row mt-3">
                <div class="col-12 col-lg-12">
                <img width="90" height="55" src="https://1scyiu2n1n5idktsl3ylwkq1-wpengine.netdna-ssl.com/wp-content/uploads/2018/07/flower-decor.png" class="aligncenter attachment-full" alt="flower-decor" loading="lazy">
                </div>
                <div class="col-12 col-lg-12 mb-2">
                    <h5 class="text-center text-white">15 Years of Quality Service in Acupuncture therapies</h5>
                </div>
                <div class="col-12 col-lg-12">
                    <h4 class="text-center text-white">A wide range of procedures & Individual approach to patient.
                        SPRAINS, STRAINS AND PAINS?Find an <br> Specialist Therapists in Our Clinic
                    </h4>
                </div>
                <div class="col-12 col-lg-12 text-center pt-4">
                    <div class="btn btn-secondary p-2" style="width:20%;border-radius:25px;">Get an Appointment</div>
                </div>
            </div>
        </section>
        ...
        <div class="row text-center">
            ...
            <div id="LastCarousel" class="carousel slide carousel-fade" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        <img class="d-block w-100"
                             src="http://dtaccu.wpengine.com/wp-content/uploads/2018/08/slider3.jpg" alt="Third slide">
                    </div>
                </div>
                <a class="carousel-control-prev" href="#LastCarousel" role="button" data-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="sr-only">Previous</span>
                </a>
                <a class="carousel-control-next" href="#LastCarousel" role="button" data-slide="next">
